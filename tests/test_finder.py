...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("from typing import Final", ImportsResult(module_aliases=set(), has_from_import=True)),
        ("from typing import Final as Final", ImportsResult(module_aliases=set(), has_from_import=False)),
        ("from typing import Final as F", ImportsResult(module_aliases=set(), has_from_import=False)),
        ("import typing; from typing import Final", ImportsResult(module_aliases={"typing"}, has_from_import=True)),
        ("import typing as tp", ImportsResult(module_aliases={"tp"}, has_from_import=False)),
        (
            "import typing as tp\nimport typing as tt\nimport typing\n"
            "from typing import Final as F\nfrom typing import Final",
            ImportsResult(module_aliases={"tp", "tt", "typing"}, has_from_import=True),
        ),
        ("import typing as tp\nimport typing as tt", ImportsResult(module_aliases={"tp", "tt"}, has_from_import=False)),
    ],
)
